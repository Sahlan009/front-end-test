  ...
  return (
    <div className="card mt-3">
      ...
      <div className="card-body">
        ...
        <button dara-testid="post-button" className="btn btn-sm btn-primary" onClick={postData}>
          Post Data
        </button>
        <button
          data-testid="clear-button" className="btn btn-sm btn-warning ml-2"
          onClick={clearPostOutput}
        >
          Clear
        </button>
        <div 
        className="alert alert-primary mt-2" role="alert">
